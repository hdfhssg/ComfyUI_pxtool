...
from .nodes import NODE_CLASS_MAPPINGS5, NODE_DISPLAY_NAME_MAPPINGS5
...
NODE_CLASS_MAPPINGS = {**NODE_CLASS_MAPPINGS, **NODE_CLASS_MAPPINGS2, **NODE_CLASS_MAPPINGS3, **NODE_CLASS_loaders, **NODE_CLASS_MAPPINGS5}
NODE_DISPLAY_NAME_MAPPINGS = {**NODE_DISPLAY_NAME_MAPPINGS, **NODE_DISPLAY_NAME_MAPPINGS2, **NODE_DISPLAY_NAME_MAPPINGS3, **NODE_DISPLAY_NAME_MAPPINGS4, **NODE_DISPLAY_NAME_MAPPINGS5}
