...
import re
# 定义删除思考内容的函数，即删除<think> 嗯，这个故事好像挺有意思的，但不太确定具体情况。</think>，即删除被<think>和</think>包裹的内容以及这两个标签
...
class DeepGen:
    ...
    def INPUT_TYPES(cls):
        ...
        return {
            "required": {
                ...
                "return_thought": ("BOOLEAN", {"default": False}),
    ...
    def deep_xgen(self, deep_model,  user_prompt, return_thought, seed=0, temperature=1.0, max_tokens=500, top_k=50, top_p=1.0, **kwargs):
        ...
        if return_thought:
            ...
            return (remove_thoughts(response), )
