...
# return output msg
def scan_model(scan_model_types, max_size_preview, skip_nsfw_preview,folders):
        ...
        for root, dirs, files in os.walk(model_folder, followlinks=True):
            for filename in files:
                ...
                if ext in model.exts:
                    ...
                    # check preview image
                    civitai.get_preview_image_or_video_by_model_path(item, max_size_preview, skip_nsfw_preview)
